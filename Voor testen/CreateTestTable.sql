...
CREATE TABLE Books (BookId BIGINT IDENTITY(1,1) PRIMARY KEY, BookCode NVARCHAR(100), Author NVARCHAR(255), Title NVARCHAR(255), Genre NVARCHAR(255), PublishDate DATE, Price MONEY, Description TEXT, NrOfPages BIGINT)	
